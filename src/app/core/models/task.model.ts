...
export interface Task {
  ...
  evidenciaFotosPDF?: string[]; // versiones base64 pequeñas para PDF (evita CORS)
...
export function createEmptyTask(overrides?: Partial<Task>): Omit<Task, 'id'> {
  ...
  return {
    ...
    descripcionIngenieria: overrides?.descripcionIngenieria || '',
